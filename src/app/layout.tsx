...
export const metadata: Metadata = {
  title: "Elite F1 Racing Team - 2025 Season",
  description: "Discover our new Formula 1 racing team competing at the highest level of motorsport with world-class talent and cutting-edge technology.",
  keywords: "Formula 1, F1 racing team, motorsport, championship, professional racing",
  metadataBase: new URL("https://f1team.example.com"),
  alternates: {
    canonical: "https://f1team.example.com"
  },
  openGraph: {
    title: "Elite F1 Racing Team",
    description: "New F1 team pushing boundaries in professional motorsport",
    url: "https://f1team.example.com",
    siteName: "F1 Racing Team",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_36N98T78GiMXZxciGAJmSwlCklc/uploaded-1764851712658-o91mygvo.jpg",
      alt: "F1 race car on track"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Elite F1 Racing Team",
    description: "Championship-caliber motorsport excellence",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_36N98T78GiMXZxciGAJmSwlCklc/uploaded-1764851712658-o91mygvo.jpg"]
  },
  robots: {
    index: true,
    follow: true
